...
function portal_save (sfile,name, value, saved)
  ...
  elseif "table" == valueType then
	...
	function remove_portal(pos,entity)
	...
	function check_portal(pos,entity)
		pos.x = math.floor(pos.x)
		pos.y = math.floor(pos.y)
		pos.z = math.floor(pos.z)
		local this_portal = {}
	...
	portal_control_ent.on_step = function(self, dtime)
		...
		if (self.timer>1)and(self.state ~= "deleted") then
			self.timer = 0
			local this_portal = {}
			if portal_list[pos.x .."_" .. pos.y .. "_" .. pos.z] ~= nil then
				this_portal = portal_list[pos.x .."_" .. pos.y .. "_" .. pos.z]
